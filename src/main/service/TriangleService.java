...
import main.utility.TriangleUtils;
...
public class TriangleService {
    ...
    public Triangle setParameters(String cleanStr) throws IOException {/*получаем из строки ввода имя и длины сторон*/
...
// рабочая версия в которую передаем проверенный параметр
//    public Triangle setParameters(String cleanStr) throws IOException {/*получаем из строки ввода имя и длины сторон*/
//        Triangle triangle = new Triangle();
//        String[] item;
//        item = cleanStr.split(",");
